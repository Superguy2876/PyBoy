...
from pyboy.plugins.game_wrapper_pkmn_red cimport GameWrapperPkmnRed
# imports end
...
cdef class PluginManager:
    ...
    cdef public GameWrapperPkmnRed game_wrapper_pkmn_red
    ...
    cdef bint game_wrapper_pkmn_red_enabled
    # plugin_cdef end
